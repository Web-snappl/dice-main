          ...
          return MaterialApp(
            ...
            theme: ThemeData(
              ...
              textTheme: ThemeData.dark().textTheme.copyWith(
                ...
                displayLarge: AppTextStyles.display(color: AppColors.textMain),
                titleLarge: AppTextStyles.title(color: AppColors.textMain),
                labelMedium: AppTextStyles.label(color: AppColors.textMuted),
              ),
