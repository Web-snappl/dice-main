  ...
  void _handleDelete(String id) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Text('Delete User', style: AppTextStyles.title(color: Colors.white)),
        content: Text('Are you sure you want to delete this user permanently?', style: AppTextStyles.body(color: Colors.grey)),
        actions: [
          TextButton(
      ...
      child: Row(
        ...
        children: [
          ...
          Row(
            children: [
              IconButton(
                icon: const Icon(Icons.gamepad, color: AppColors.gold),
            ...
            return isMobile 
              ? Column(
                  children: [
                    ...
                    _buildSummaryCard('Revenue', _profitStats['totalProfit'], Icons.attach_money, AppColors.gold),
                  ],
                )
              : Row(
                  children: [
                    ...
                    Expanded(child: _buildSummaryCard('Revenue', _profitStats['totalProfit'], Icons.attach_money, AppColors.gold)),
                  ],
                );
          },
        ),
          ...
          child: Container(
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  labelText: 'Name',
                  labelStyle: AppTextStyles.label(color: AppColors.textMuted, fontSize: 12),
                  filled: true,
                  fillColor: AppColors.surface,
                  border: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(8),
            ...
            children: [
              ...
              Row(
                children: [
                  Expanded(
                    child: Material(
                      color: _walletAction == 'DEPOSIT' ? Colors.green : AppColors.surface,
                      borderRadius: BorderRadius.circular(8),
                      child: InkWell(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            ...
                            style: AppTextStyles.body(
                              fontSize: 14,
                              fontWeight: FontWeight.bold,
                              color: _walletAction == 'DEPOSIT' ? Colors.black : AppColors.textMuted,
                            ),
                          ),
                        ),
                      ),
                  ...
                  Expanded(
                    child: Material(
                      color: _walletAction == 'WITHDRAW' ? AppColors.danger : AppColors.surface,
                      borderRadius: BorderRadius.circular(8),
                      child: InkWell(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            ...
                            style: AppTextStyles.body(
                              fontSize: 14,
                              fontWeight: FontWeight.bold,
                              color: _walletAction == 'WITHDRAW' ? Colors.white : AppColors.textMuted,
                            ),
                          ),
                        ),
                      ),
              ...
              AppButton(
                fullWidth: true,
                variant: _walletAction == 'DEPOSIT' ? ButtonVariant.primary : ButtonVariant.danger,
          ...
          FittedBox(
            ...
            child: Text(
              ...
              style: AppTextStyles.digital(
                fontSize: 28,
                fontWeight: FontWeight.bold,
                color: (label.toLowerCase().contains('revenue') && (value is num && value < 0)) ? AppColors.danger : Colors.white,
              ),
            ),
          ),
        ],
